...
{
    APP_PROF_LOG_PRINT(LEVEL_INFO, "----- enum: %d\n", enSnsType);
    switch (enSnsType) {
#ifdef SNS0_CVSENS_CV2003
    case SENSOR_CVSENS_CV2003:
        return &stSnsCV2003_Obj;
#endif
#ifdef SNS0_CVSENS_CV2003_1L
    case SENSOR_CVSENS_CV2003_1L:
    ...
    case SENSOR_GCORE_GC2083:
        APP_PROF_LOG_PRINT(LEVEL_INFO, "----- SENSOR_GCORE_GC2083 \n");
...
#endif
#ifdef SNS0_GCORE_GC2385_1L
    case SENSOR_GCORE_GC2385_1L:
...
int app_ipcam_Vi_Mipi_Start(void)
{
    ...
    for (CVI_U32 i = 0; i < g_pstViCtx->u32WorkSnsCnt; i++) {
        ...
        if(((!pstSysCfg->astSwitchCfg.bMipiSwitchEnable) || (i == 0)))
        {

...
typedef enum _SENSOR_TYPE_E {
    SENSOR_NONE,
    SENSOR_CVSENS_CV2003,
    SENSOR_CVSENS_CV2003_1L,
    SENSOR_CVSENS_CV2003_1L_SLAVE,
    SENSOR_CVSENS_CV2003_1L_SLAVE1,
    SENSOR_CVSENS_CV4001,
    SENSOR_GCORE_GC1054,
    SENSOR_GCORE_GC2053,
    ...
    SENSOR_GCORE_GC2083,
    SENSOR_GCORE_GC1084,
    SENSOR_GCORE_GC1084_SLAVE,
    SENSOR_GCORE_GC1084_SLAVE1,
    SENSOR_GCORE_GC1084_SLAVE2,
    SENSOR_GCORE_GC2093,
    SENSOR_GCORE_GC2093_SLAVE,
    SENSOR_GCORE_GC2385_1L,
    SENSOR_GCORE_GC4653,
    SENSOR_GCORE_GC4023,
    ...
    SENSOR_SMS_SC2331_1L_SLAVE,
    SENSOR_SMS_SC2331_1L_SLAVE1,
    SENSOR_SMS_SC2335,
    SENSOR_SMS_SC2336,
    SENSOR_SMS_SC2336_SLAVE,
    SENSOR_SMS_SC2336_SLAVE1,
    SENSOR_SMS_SC2336_1L,
    SENSOR_SMS_SC2336P,
    SENSOR_SMS_SC2336P_1L,
    SENSOR_SMS_SC3335,
    SENSOR_SMS_SC3335_SLAVE,
    SENSOR_SMS_SC3336,
    SENSOR_SMS_SC3336_1L,
    SENSOR_SMS_SC3336_1L_SLAVE,
    SENSOR_SMS_SC401AI,
    SENSOR_SMS_SC501AI_2L,
    SENSOR_SMS_SC4210,
    SENSOR_SMS_SC8238,

...
typedef struct APP_SVC_PARAM_T {
	CVI_BOOL bsvc_enable;
	CVI_BOOL bfg_protect_en;
	CVI_S32  s32fg_dealt_qp;
	CVI_BOOL bcomplex_scene_detect_en;
	CVI_U32  u32complex_scene_low_th;
	CVI_U32  u32complex_scene_hight_th;
	CVI_U32  u32middle_min_percent;
	CVI_U32  u32complex_min_percent;
	CVI_BOOL bsmart_ai_en;
} APP_SVC_PARAM_S;
...
typedef struct APP_VENC_STITCHING_CFG_T {
    CVI_BOOL bEnableVpssStitching;
    CVI_U32 VpssStitchingGrpSrc1;
    CVI_U32 VpssStitchingChnSrc1;
    CVI_U32 VpssStitchingGrpSrc2;
    CVI_U32 VpssStitchingChnSrc2;
} APP_VENC_STITCHING_CFG_S;

#ifdef __CV186AH__
typedef struct APP_VENC_FRAME_SRC_CFG_T {
    MOD_ID_E    enModId;
    CVI_S32     s32DevId;
    CVI_S32     s32ChnId;
